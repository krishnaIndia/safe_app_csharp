...
namespace SafeApp.Utilities {
  public interface IAppBindings {
    ...
    void EncodeUnregisteredReq(string appId, IntPtr lenPtr, Action<FfiResult, uint, string> callback);
    void EncodeContainerReq(IntPtr containerReqPtr, Action<FfiResult, uint, string> callback);
    void EncodeShareMDataReq(IntPtr shareMDataReqPtr, Action<FfiResult, uint, string> callback);
